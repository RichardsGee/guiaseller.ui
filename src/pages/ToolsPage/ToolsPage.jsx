...
import styles from './ToolsPage.module.css'; // Importando o CSS específico da página
import '../../styles/styles.css'; // Importando o CSS global
import MainContent from '../../components/MainContent/MainContent'; 
import { AuthContext } from '../../context/AuthContext';
import ToolsList from './ToolsList'; // Importando o componente de lista
import { ferramentasData } from './ToolsData'; // Importando os dados das ferramentas
    ...
    <MainContent>
      ...
      <div className="main-content">
        <div className="contentContainer">
          <h1 className="title">Ferramentas</h1>
